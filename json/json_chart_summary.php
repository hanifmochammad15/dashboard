...
where a.team_id in('1','2','3') 
and c.create_time::date >='$tglawal'
        and c.create_time::date <='$tglakhir'
and a.status_user=1 and a.level_user=1 and d.id in('1','4','13','14','15','12','16','3','21','17','22'))::NUMERIC *100),2)
 as percentage  
from teams as a
join users as b on b.login=a.user_login
join ticket as c on c.user_id=b.id
...
and c.create_time::date >='$tglawal'
        and c.create_time::date <='$tglakhir'
 and a.status_user=1 and a.level_user=1 and d.id in('1','4','13','14','15','12','16','3','21','17','22')
