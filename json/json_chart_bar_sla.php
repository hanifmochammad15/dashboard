...
$count_bahaya = 0;
    foreach ($array as $key => $value) {
        ...
        if($value['responsible_user'] == $row['user_login'] && $value['kondisi'] == $kondisi1){
             
            $count_bahaya++;
        }

    }
        $dataPointz[$x][$kondisi1] = array( 
...
$count_document = 0;
    foreach ($array as $key => $value) {
        ...
        if($value['responsible_user'] == $row['user_login'] && $value['kondisi'] == $kondisi2){
             
            $count_document++;
        }

    }
        $dataPointz[$x][$kondisi2] = array( 
                        'label'=>$row['user_login'] , 
                        'y'=>$count_document,
                        );
$kondisi3='aman';
$count_aman = 0;
    foreach ($array as $key => $value) {
        ...
        if($value['responsible_user'] == $row['user_login'] && $value['kondisi'] == $kondisi3){
             
            $count_aman++;
        }

    }
        $dataPointz[$x][$kondisi3] = array( 
                        'label'=>$row['user_login'] , 
                        'y'=>$count_aman,
                        );

$kondisi4='wanti-wanti';
$count_wanti_wanti = 0;
    foreach ($array as $key => $value) {

        if($value['responsible_user'] == $row['user_login'] && $value['kondisi'] == $kondisi4){
             
            $count_wanti_wanti++;
        }

    }
        $dataPointz[$x]['wantiwanti'] = array( 
                        'label'=>$row['user_login'] , 
                        'y'=>$count_wanti_wanti,
                        );
        
$kondisi5='follow up sales';
$count_fuw = 0;
    foreach ($array as $key => $value) {

        if($value['responsible_user'] == $row['user_login'] && $value['kondisi'] == $kondisi5){
             
            $count_fuw++;
        }

    }
        $dataPointz[$x]['fuw'] = array( 
                        'label'=>$row['user_login'] , 
                        'y'=>$count_fuw,
                        );
     $x++;
