...
<a href="<?php echo BaseURL() .'bar_chart_uw_team2_3.php?team='.$team.'&tglawal='.$tglawal.'&tglakhir='.$tglakhir;?>" class="next">Chart Ticket Assess</a>
<hr />
...
function myStatus() {
 ...
 //alert (tglawal);
  var link='http://dashboard.asuransibintang.com/dashboard/chart/chart-types/table_uw_team2_3.php?team='+team;
