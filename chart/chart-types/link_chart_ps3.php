...
$x=0;
    ...
    $ticket[$x]['diff']['days'] = floor(($ticket[$x]['diff']['raw']/3600)/24);
     echo  'ticket '.$ticket[$x]['tn'];
    echo '| days '. $ticket[$x]['diff']['days'];

     echo '<br>';
      echo '| today '. $today;
    echo '<br>';
      echo '| new_create_time '. $ticket[$x]['new_create_time'];
      echo '<br>';
    $ticket[$x]['pemulih'] = 0;
    ...
    if ($ticket[$x]['queue'] == 'Sales::POS DIRECT::Pos BSD') {
     ...
     echo ' | param_dadakan ' .$param_dadakan; 
    echo '<br/>'; 
    echo ' | param_dadakan_wanti_wanti ' .$param_dadakan_wanti_wanti; 
    echo '<br/>'; 
    echo ' | param_dadakan_bahaya ' .$param_dadakan_bahaya; 
    echo '<br/>'; 
