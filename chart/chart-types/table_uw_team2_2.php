...
<a href="<?php echo BaseURL() .'bar_chart_uw_team2_2.php?team='.$team.'&tglawal='.$tglawal.'&tglakhir='.$tglakhir;?>" class="next">Chart Ticket Status Assess</a>
<hr />
...
function myStatus() {
 ...
 //alert (tglawal);
  var link='http://dashboard.asuransibintang.com/dashboard/chart/chart-types/table_uw_team2_2.php?team='+team;
