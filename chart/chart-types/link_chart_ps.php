...
document.location="http://dashboard.asuransibintang.com/dashboard/board/index.php/login";
</script>
...
select user_login, 0 as jumlah_ticket 
        ...
        and c.create_time::date >='$tglawal'
        and c.create_time::date <='$tglakhir'
        group by a.id,a.user_login,a.status_user,a.team_id,d.name order by user_login asc
")or die(pg_last_error($conn));
