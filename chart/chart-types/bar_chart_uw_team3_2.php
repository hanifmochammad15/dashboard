...
?>
<h1>BAR CHART CHART TOTAL ASSESS POLICY UNDERWRITING</h1>
<p>Date Awal: <input name="awal" type="text" id="datepickerawal" > - Date Akhir: <input name="akhir" type="text" id="datepickerakhir" ></p>

<a href="<?php echo BaseURL() .'table_uw_team3_2.php?team='.$team.'&tglawal='.$tglawal.'&tglakhir='.$tglakhir;?>" class="next">Table</a>
<a href="<?php echo BaseURL() .'bar_chart_uw_team3_3.php?team='.$team.'&tglawal='.$tglawal.'&tglakhir='.$tglakhir;?>" class="next">Invoiced & Paid Fully</a>
<hr />
<!--
...
echo $team;
 ...
 select user_login , 0 as jumlah_ticket from(SELECT unnest(ARRAY['dwi.prasetyo','trivina.setyawati','rini.aryani','lisbet','queue']) as user_login)as a 
       ...
       $Risk_Accepted = pg_query($nextg_conn, "
        ...
        select user_login , 0 as jumlah_ticket from(SELECT unnest(ARRAY['dwi.prasetyo','trivina.setyawati','rini.aryani','lisbet']) as user_login)as a 
            ...
            and c.ticket_type='Risk Approval'
                        ...
                        and substr(a.sales_number, 2 ,2)!='16'
              and b.actiontime::date >='$tglawal'
