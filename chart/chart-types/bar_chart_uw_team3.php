...
<a href="<?php echo BaseURL() .'table_uw_team3.php?team=3&tglawal=2020-01-01&tglakhir=2020-04-21&status=no';?>" class="next">Table</a>
<hr />
<!--
...
echo $team;
        $Approve = pg_query($nextg_conn, "
            ...
            select  b.userid as user_login from tbl_so_sales_details as a
            ...
            GROUP BY b.userid)
            UNION
            select  b.userid as user_login,COALESCE(count (c.ticket_number),0)as jumlah_ticket from tbl_so_sales_details as a
            join tbl_so_sales_tracker as b on a.sales_number=b.sales_number and a.revision_number=b.revision_number
            join tbl_helpdesk_integration as c on a.sales_number=c.sales_number and a.revision_number=c.revision_number
            where b.sales_status in('Approve')
            and c.ticket_type='Risk Approval'
