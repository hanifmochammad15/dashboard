;(function (global, factory) {
    ...
    var months$3 = 'leden_únor_brezen_duben_kveten_cerven_cervenec_srpen_zárí_ríjen_listopad_prosinec'.split('_'),
        monthsShort = 'led_úno_bre_dub_kve_cvn_cvc_srp_zár_ríj_lis_pro'.split('_');

    var monthsParse = [/^led/i, /^úno/i, /^bre/i, /^dub/i, /^kve/i, /^(cvn|cerven$|cervna)/i, /^(cvc|cervenec|cervence)/i, /^srp/i, /^zár/i, /^ríj/i, /^lis/i, /^pro/i];
    ...
    var monthsRegex$1 = /^(leden|únor|brezen|duben|kveten|cervenec|cervence|cerven|cervna|srpen|zárí|ríjen|listopad|prosinec|led|úno|bre|dub|kve|cvn|cvc|srp|zár|ríj|lis|pro)/i;
    ...
    hooks.defineLocale('mt', {
        months : 'Jannar_Frar_Marzu_April_Mejju_Gunju_Lulju_Awwissu_Settembru_Ottubru_Novembru_Dicembru'.split('_'),
        monthsShort : 'Jan_Fra_Mar_Apr_Mej_Gun_Lul_Aww_Set_Ott_Nov_Dic'.split('_'),
        weekdays : 'Il-Hadd_It-Tnejn_It-Tlieta_L-Erbgha_Il-Hamis_Il-Gimgha_Is-Sibt'.split('_'),
