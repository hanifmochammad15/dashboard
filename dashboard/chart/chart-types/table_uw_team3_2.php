...
<a href="<?php echo BaseURL() .'bar_chart_uw_team3_2.php?team='.$team.'&tglawal='.$tglawal.'&tglakhir='.$tglakhir;?>" class="next">Chart Ticket Status</a>
<hr />
...
if($status=='approve'){
       ...
       $Created = pg_query($nextg_conn, "
            ...
            and substr(a.sales_number, 2 ,2)!='16'
              and b.actiontime::date >='$tglawal'
             and b.actiontime::date <='$tglakhir'")or die(pg_last_error($nextg_conn));
        echo '<table border="1">';
          echo '<tr>';
          echo '<th> no </th>';
            echo '<th> sales_number </th>';
...
function myStatus() {
 ...
 //alert (tglawal);
  var link='http://dashboard.asuransibintang.com/dashboard/chart/chart-types/table_uw_team3_2.php?team='+team;
