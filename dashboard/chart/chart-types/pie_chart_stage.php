...
<hr />
<a href="<?php echo BaseURL() .'bar_chart_stage.php?team='.$team.'&tglawal='.$tglawal.'&tglakhir='.$tglakhir;?>" class="next">Bar &raquo;</a>
...
//Disable Blank
/*
$total2=count($master_array);
$realtotal=$total2-1;
$stageblank='';
$blank= $realtotal-($branchUW+$maker+$reinsurance+$hoUW);
$total=$branchUW+$maker+$reinsurance+$hoUW+$blank;
...
$totalPercentage= $branchUWPercentage+$makerPercentage+$reinsurancePercentage+$hoUWPercentage+$blankPercentage;
