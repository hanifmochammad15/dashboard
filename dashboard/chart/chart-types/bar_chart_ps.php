...
document.location="http://dashboard.asuransibintang.com/dashboard/board/index.php/login"; </script>
...
var chart1 = new CanvasJS.Chart("chartContainer1", {
    ...
    title: {
        text: "Chart Ticket SLA Team <?php echo $team; ?>"
    },
     subtitles: [{
     ...
     data: [
        {
            ...
            dataPoints: <?php echo json_encode($dataPointz1, JSON_NUMERIC_CHECK); ?>
        },{
            type: "stackedColumn",
            name: "document",
            showInLegend: true,
            yValueFormatString: "#,##0 Ticket",
            dataPoints: <?php echo json_encode($dataPointz2, JSON_NUMERIC_CHECK); ?>
        },{
            type: "stackedColumn",
            name: "aman",
            showInLegend: true,
            yValueFormatString: "#,##0 Ticket",
            dataPoints: <?php echo json_encode($dataPointz3, JSON_NUMERIC_CHECK); ?>
        },
        {
            type: "stackedColumn",
            name:  "wanti-wanti",
            showInLegend: true,
            yValueFormatString: "#,##0 Ticket",
            dataPoints: <?php echo json_encode($dataPointz4, JSON_NUMERIC_CHECK); ?>
        }
    ]
});
