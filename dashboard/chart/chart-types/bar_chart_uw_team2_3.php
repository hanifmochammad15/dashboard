...
<a href="<?php echo BaseURL() .'table_uw_team2_3.php?team='.$team.'&tglawal='.$tglawal.'&tglakhir='.$tglakhir;?>" class="next">Table</a>

<a href="<?php echo BaseURL() .'bar_chart_uw_team2_2.php?team='.$team.'&tglawal='.$tglawal.'&tglakhir='.$tglakhir;?>" class="next">App, Ass, & Risk Acc</a>
<hr />
<!--
