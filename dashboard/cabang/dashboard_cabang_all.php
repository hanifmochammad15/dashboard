...
$query_read = pg_query($next,"
	...
	when kondisi ='aman' then 5
      ...
      tn,title,new_create_time,queue,responsible_user,
        ...
        FROM
            dblink (
                'host=10.11.23.84 user=postgres dbname=otrs2_4_201610',
                $$ 
...
LEFT join (select DISTINCT ON (ticket_number) * from 	tbl_helpdesk_integration where waktu_kejadian is not null) as a on x.tn=a.ticket_number and date_part('year', waktu_kejadian) >='2019'
