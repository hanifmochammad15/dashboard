...
-->
    ...
    <div class="tab-pane" id="apps_bahaya">
        <section class="col-lg-12 connectedSortable">
          <div class="card card-primary" id="cp_card">
          <div class="card-header">
                <h3 class="card-title">OTRS Bahaya</h3>
...
function load_summary_chart(tglawal=null,tglakhir=null){
  if (tglawal==null) {
    var tglawal = '<?php echo $tglawal;?>';
  }else{
    var tglawal = tglawal;
...
$.ajax({
    ...
    method : "POST",
    data : {summary_otrs_opp_2days: summary_otrs_opp_2days,tglawal:tglawal,tglakhir:tglakhir},
    async : true,
    dataType : 'json',
    success: function(data){
             $.each(data, function(key, value){
...
$.ajax({
    ...
    method : "POST",
    data : {bar_opp_2days: bar_opp_2days,tglawal:tglawal,tglakhir:tglakhir,team:team},
    async : true,
    dataType : 'json',
    success: function(data){
              for (var i = 0; i < data.length; i++) {
                              ...
                              for (i=0;i< data['list'].length;i++) {
                                ...
                                $.ajax({
                                  ...
                                  success: function(response){
                                    ...
                                    var trHTML = '';
                                        trHTML += '<tr><td>' + response['list'].tn + '</td><td>'+ response['list'].title + '</td><td>' + response['list'].maker + '</td><td>' + response['list'].uw + '</td><td>'+response['list'].reas+'</td></tr>';
