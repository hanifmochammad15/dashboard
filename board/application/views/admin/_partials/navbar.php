  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light fixed-top">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item"><!-- 
            ...
            <a class="nav-link active" href="#chartotrs" id="chartotrs2" data-toggle="tab">Home</a>
          </li>
          <li class="nav-item">
            <!-- <a href="<?php //echo base_url('/index.php/admin/otrsbahaya'); ?>" class="nav-link">App Bahaya</a> -->
            <a class="nav-link" href="#apps_bahaya" id="apps_bahaya2" data-toggle="tab">Rincian SLA Bahaya</a>
          </li>
          <li class="nav-item">
            <!-- <a href="<?php //echo base_url('/index.php/admin/otrsbahaya'); ?>" class="nav-link">App Bahaya</a> -->
            <a class="nav-link" href="#dashboard_opp" id="dashboard_opp2" data-toggle="tab">Dashboard OPP</a>
          </li>
        </ul>
...
<!-- 
    <div class="row">
                <div class="col-lg-2">
                  <label class="form-inline ml-2">Tgl Awal:</label>
                </div>
                  <div class="col-lg-4">
                ...
                <div class="col-lg-2">
                  <label class="form-inline ml-2">Tgl Akhir:</label>
                </div>
                  <div class="col-lg-4">
                  <div class="form-inline ml-3">
